...
const DICT = {
  ...
  'skill.water_pipe': { en: 'Water pipe', ko: '급수 배관' },
  'skill.sanitary_pipe': { en: 'Sanitary pipe', ko: '오·배수 배관' },
  'skill.fire_protection': { en: 'Fire protection', ko: '소방' },
  'skill.window_frame': { en: 'Window frame', ko: '창호 프레임' },
  'skill.window_glass': { en: 'Window glass', ko: '유리 시공' },
  'skill.ducting': { en: 'Ducting', ko: '덕트' },
  'skill.roofing': { en: 'Roofing', ko: '지붕/방수' },
  'skill.installer': { en: 'Installer', ko: '설치' },
  'skill.ceiling': { en: 'Ceiling installation', ko: '천장 시공' },
  'skill.wall_panel': { en: 'Interior wall panel', ko: '내부 벽 패널' },
  'skill.welding': { en: 'Welding', ko: '용접' },
  ...
  'dash.assessTitle': {
    en: 'Construction Assessment · Cross-country Comparison',
    ko: '건설 총평 · 국가별 비교 분석',
  },
  'dash.assessDiagnosis': { en: 'Overall Diagnosis', ko: '종합 진단' },
  'dash.assessCompare': { en: 'Progress practices by country', ko: '국가별 진행 관행 비교' },
  'dash.assessNotes': { en: 'Reference notes', ko: '참고사항' },
  'dash.assessMore': { en: 'Show comparison & notes', ko: '비교·참고사항 보기' },
  'dash.assessLess': { en: 'Hide', ko: '접기' },
  'dash.colDim': { en: 'Aspect', ko: '구분' },
  'dash.colPh': { en: 'Philippines', ko: '필리핀' },
  'dash.colKr': { en: 'Korea', ko: '한국' },
  'dash.colOther': { en: 'Overseas (developed)', ko: '해외(선진국)' },
  'dash.assessDisclaimer': {
    en: 'The comparison reflects broad industry tendencies and varies by company and site.',
    ko: '아래 비교는 업계의 일반적 경향으로 회사·현장에 따라 다를 수 있습니다.',
  },
  'dow.mon': { en: 'Mon', ko: '월' },
  'dow.tue': { en: 'Tue', ko: '화' },
  'dow.wed': { en: 'Wed', ko: '수' },
  ...
  'pay.thCanteen': { en: 'Canteen', ko: '식당' },
  'pay.thAdjustment': { en: 'Adj +', ko: '조정 가산' },
  'pay.thAdjustmentDeduct': { en: 'Adj −', ko: '조정 공제' },
  'pay.saveError': { en: 'Failed to save. Please try again.', ko: '저장에 실패했습니다. 다시 시도해 주세요.' },
  ...
  'emp.fCanteenDebt': { en: 'Canteen debt (₱)', ko: '식당 외상 (₱)' },
  'emp.thCanteenDebt': { en: 'Canteen debt', ko: '식당 외상' },
  'emp.fAdjustment': { en: 'Adjustment + (₱)', ko: '조정 가산 (₱)' },
